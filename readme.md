...
**Yassine Ennaya** – Créé le 07/02/2026
...
│
├── k8s/
│   └── *.yaml                     # Manifests Kubernetes pour Jobs / CronJobs
│
├── monitoring/
│   ├── prometheus.yml
...
### 1️⃣ Analyse Exploratoire & Préparation NLP
